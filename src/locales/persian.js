module.exports = {
    GLOBAL: {
      EVERYONE: "همه",
      NOT_SPECIFIED: "تعریف نشده",
      PROVIDE_ARGS: "لطفا حرفی را به کار ببرید",
      ERROR: "خطای غیر منتظره",
      NAME: "نام",
      NOT_AN_OPTION: "یک گزینه نمی باشد {option}",
      SUCCESS: "موفقیت",
      REASON: "دلیل",
      URL: "URL",
      NONE: "هیچ کدام",
    ...
    GUILD: {
      ...
      LEFT: "با موفقیت از سرور خارج شد **{guild_name}**",
      LEVEL_UP_MESSAGES: "پیام ارتقاع سطح",
      ANNOUNCE_CHANNEL: "بخش پیام رسانی",
      SUGGEST_CHANNEL: "بخش ایده ها",
      WELCOME_CHANNEL: "بخش خوش آمد",
      LEAVE_CHANNEL: "بخش ترک سرور",
      PREFIX: "نماد",
      IS_VERIFIED: "بله, این سرور تایید شده است",
      IS_PARTNERED: "بله, این سرور به اشتراک گزاشته شده است",
      NOT_VERIFIED: "خیر, این سرور تایید نشده است",
      NOT_PARTNERED: "خیر, این سرور به اشتراک گزاشته نشده است",
      OWNER: "دارنده ی سرور",
      CHANNEL_C: "شمارش بخش ها",
      EMOJI_C: "شمارش ایموجی ها",
      ROLES_C: "شمارش رول ها",
      MEMBER_C: "شمارش اعضا",
      REGION: "Region",
      VERIFICATION: "سطح تایید شده",
      MFA: "MFA سطح",
      BOOSTS: "Boosts",
    ...
    MEMBER: {
      ...
      USERNAME: "نام حقیقی",
      NICKNAME: "نام",
      PROVIDE_MEMBER: "لطفا یک از اعضا را انتخواب کنید",
      NOT_FOUND: "فرد پیدا نشد",
      CANNOT_BE_BANNED: "این فرد قابل بن شدن نیست",
      DM_BAN_MESSAGE: " شده اید **ban** **{guild_name}**از, **{ban_reason}**سلام شما به دلیل",
      GUILD_BAN_MESSAGE:
        "بن شد. همچنین برای این فرد پیغام شخصی فرستاده شد **{ban_reason} با موفقیت به دلیل  {member} شخص",
      BOT_DATA: "دیتا رباط در حال حاضر قادر به ذخیره نیست به همین دلیل نمیتوانم به ان متصل شوم",
    },
    ROLES: {
      MY_ROLE_NOT_HIGH_ENOUGH: "رول من به مقدار کافی بالا نمی باشد **{role}**",
      MY_ROLE_MUST_BE_HIGHER: "باشد **{member}** رول من باید بالا تر از بالا ترین رول ",
      YOUR_ROLE_MUST_BE_HIGHER: "باشد **{role}**رول شما باید بالا تر از ",
      PROVIDE_ROLE: "لطفا یک رول را انتخواب کنید",
      ALREADY_HAS_ROLE: "شخص این رول را در حال حاضر داراست",
      ADDED_ROLE_TO: "داده شد {member} با موفقیت به **{role}**رول",
    },
    IMAGE: {
      CLICK_TO_VIEW: "[اینجا کلیک کنید اگر تصویر نمایان نشد]",
      CLYDE: "Clyde",
    ...
    ANIMAL: {
      CAT_FACT: "دانستنی درباره گربه",
      DOG_FACT: "دانستنی درباره سگ",
      SNAIL_FACT: "دانستنی درباره حلزون",
      COW: "گاو",
    },
    BOT_OWNER: {
    ...
    LEVELS: {
      ...
      LEVEL: "سطح",
      LEADERBOARD: "نمایشگر",
      MEMBER_IS_LEVEL: " **امتیاز{user_xp}** میباشد با داشتن **{level}** در سطح {member}",
      RESET_CONF: "تمام امتیازات را حذف کنم؟ بله/خیر",
      RESET_SUCCESS: "امتیازات همه با موفقیت حذف شد",
      RESET_CANCEL: "حذف امتیازات صورت نگرفت",
      PROVIDE_AMOUNT: "لطفا اندازه ای انتخواب کنید",
      PROVIDE_VALID_NR: "لطفا یک *عدد* انتخاب کنید",
      GIVE_XP_SUCCESS: "داده شد **{member}** **امتیاز{amount}**",
    },
    MUSIC: {
      MUST_BE_IN_VC: "باشی vc باید داخل یک ",
      NO_QUEUE: "هیچ اهنگی در حال حاضر پخش نمیشود",
      QUEUE_CLEARED: "لیست پاک شد",
      QUEUE: "لیست اهنگ",
      BETWEEN_0_100: "مقدار صدا باید بین ۰ تا ۱۰۰ باشد",
      VOL_SUCCESS: "رسید {vol}% صدا با موفقیت به",
      PLAYING: "در حال پخش",
      PAUSED: "متوقف",
      DURATION: "اندازه",
      ...
      ADDED_TO_QUEUE: "به لیست اضافه شد {song} آهنگ",
      ADDED_PL_TO_QUEUE: "اضافه شد به لیست Playlist ({length} songs)",
      PROVIDER_NOT_SUPP: "That provider is not supported",
      NOW_PLAYING: "اهنگ در حال پخش:",
      REQUESTED_BY: "درخواست شده توسط",
      NO_PERMS: "را ندارم VC اجازه وارد شدن به این ",
      NOT_SAME_VC: "باشید که رباط نیز هست VC باید در ",
      ALREADY_IN_VC: "هستم VC من هم اکنون در ",
      MUST_BE_SAME_VC: "You must be in the same voice chat with the bot",
      NO_RESULTS: "اهنگی یافت نشد",
      JOIN_ERROR: "برای وارد شدن به مشکلی برخورد کردم مطمعن شوید که پر نمیباشد",
    },
    ECONOMY: {
      MONEY: "پول",
      BANK: "بانک",
      BALANCE: "مقدار",
      DAILY_ERROR: "شما هم اکنون روزانه را دریافت کرده اید",
      WEEKLY_ERROR: "شما هم اکنون هفتگی را دریافت کرده اید",
      DAILY_SUCCESS: "سکه به شما به خواطر روزانه به شما اصاف شد **{amount}**",
      WEEKLY_SUCCESS: "سکه به خواطر هفتگی به شما اضاف شد **{amount}**",
      STORE_EMPTY:
        "به آن اضافه کند `{prefix}store add <item>` مغازه سرور خالی میباشد از یکی از ادمین های سرور درخواست کنید تا ب استفاده از  ",
      PROVIDE_ITEM_TO_BUY: "لطفا یکی از موارد را برای خرید انتخواب کنید",
      NOT_ENOUGH_MONEY: "شما انقدر پول ندارید",
      BUY_SUCCESS: "خریداری شد **{price}** با قیمت **{item}** با موفقیت",
      NOT_FOUND_STORE:
